...
parser.add_argument('--save_dir_models', type=str, default='/saved_models', help='root of models')

parser.add_argument('--save_dir_features', type=str, default='/saved_features', help='root of features')
...
def main_train_cd():
    ...
    x_domains = [("all", "1"), ("all", "2"), ("all", "3"), ("all", "4"), ("all", "5"), ("all", "6"), ("all", "7"), ("all", "8"), ("all", "9")]
    classes = ["L H", "R H", "Feet", "Tongue"]
    ...
    # save a copy of training files and results:
    ...
    for i,j in enumerate(x_domains):
        ...
        for run_id in range(args.num_runs):
            ...
            src_train_dl, trg_train_dl = data_generator(configs, i)
